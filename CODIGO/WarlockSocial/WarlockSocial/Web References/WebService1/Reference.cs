...
namespace WarlockSocial.WebService1 {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="WebServiceFase2PortBinding", Namespace="http://WebServicefase/")]
    public partial class WebServiceFase2 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WebServiceFase2() {
            this.Url = global::WarlockSocial.Properties.Settings.Default.WarlockSocial_WebService_WebServiceFase2;
        ...
        /// <remarks/>
        public void RegistrarUsuarioAsync(string nickName, string contrasena, string correo, string fecha_nac) {
            this.RegistrarUsuarioAsync(nickName, contrasena, correo, fecha_nac, null);
        }
        
        /// <remarks/>
        public void RegistrarUsuarioAsync(string nickName, string contrasena, string correo, string fecha_nac, object userState) {
            ...
            this.InvokeAsync("RegistrarUsuario", new object[] {
                        ...
                        contrasena,
                        correo,
                        fecha_nac}, this.RegistrarUsuarioOperationCompleted, userState);
        }
